...
### Snapshot Rules
- Snapshots must EXCLUDE `.git/` directory
- Snapshots must EXCLUDE `history/` directory (avoid recursion)
- Final snapshot (step_N) must match current working tree exactly (excluding history/)
